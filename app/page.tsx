...
export const metadata: Metadata = {
  ...
  description:
    "Embark on an extraordinary journey into the depths of space with our immersive space tourism experience. Discover a world beyond our own, where the boundaries of possibility fade away. Get ready for an adventure that takes you far beyond the edge of our atmosphere, offering a true and exhilarating cosmic escapade.",
};
