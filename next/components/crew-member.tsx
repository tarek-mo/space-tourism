import TCrewMember from "@/types/TCrewMember";
import Image from "next/image";

const CrewMember = ({ name, role, bio, images }: TCrewMember) => {
  return (
      ...
      <div className="self-stretch lg:pb-0 md:pt-10 lg:pt-0 pb-8 md:pb-0 md:w-auto relative mb-8 md:mb-0">
        <div className="border-b-1 border-g md:border-b-0 md:w-auto mx-auto">
          <Image
            width={177}
            height={222}
            className="md:w-112 md:h-144 lg:object-contain mx-auto lg:w-140"
            src={images.png}
            alt={name}
          />
        </div>
